...
var APP_ID = '4WklmhgPmrryGCZ8MhfvX3MqwL7hbFs6SDPVM9xC';
var API_KEY = '8JkfGndPKxF7QdvvkpGE4eKoQ5iecFP4oHcsf0XB';
...
var _contacts_model = require('./contacts_model');

var _contacts_model2 = _interopRequireDefault(_contacts_model);

var ContactsCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/contacts',

  model: _contacts_model2['default'],
...
},{"./contacts_model":3,"backbone":9}],3:[function(require,module,exports){
'use strict';
...
var Router = _backbone2['default'].Router.extend({
  ...
  showContactsList: function showContactsList() {
    ...
    this.contacts.fetch().then(function () {
      ...
      router.$el.html((0, _viewsContactlist2['default'])(router.contacts.toJSON()));
    });
  },
  ...
  showSpecificContact: function showSpecificContact(contactId) {
    ...
    if (contact) {
      ...
      (function () {
        var router = _this;
        contact = _this.contacts.add({ objectId: todoId });
        _this.showSpinner();
...
},{"./contacts_collection":2,"./views/contact":6,"./views/contactlist":7,"backbone":9,"jquery":10}],6:[function(require,module,exports){
"use strict";
